...
<div class="visualization-container breakout-medium story-emphasis" id="biotech-ipo-outcomes">
    <div class="chart-header">
        <h3>What happened to pandemic-era IPOs</h3>
    </div>
    <div id="biotech-donut-chart"></div>
    <div class="chart-footer">
        <p class="chart-caption">"Distressed" includes reverse mergers, liquidations, bankruptcies, and OTC trading.</p>
        <p class="data-source">Source: SEC filings and press releases</p>
    </div>
</div>

<!-- Screen Reader Accessible Table -->
<table class="sr-only" summary="Biotech IPO outcomes showing that 73% remain independent">
    <caption>What happened to pandemic-era IPOs</caption>
    <thead>
        <tr>
